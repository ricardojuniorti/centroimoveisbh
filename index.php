    ...
    <div class="page">
       ...
       <!-- Page Header-->
                  ...
                  <div class="rd-navbar-main-element">
                    <div class="rd-navbar-nav-wrap">
                      ...
                      <ul class="rd-navbar-nav">
                        ...
                        <li class="rd-nav-item"><a class="rd-nav-link" href="#services">Serviços</a></li>
                        <li class="rd-nav-item"><a class="rd-nav-link" href="#projects">Imoveis</a></li>
        ...
        <section class="section swiper-container swiper-slider swiper-slider-classic"  data-loop="true" data-autoplay="4859" data-simulate-touch="true" data-direction="vertical" data-nav="false">
          <div class="swiper-wrapper text-center">
            <div class="swiper-slide" data-slide-bg="images/banner-slider-1.jpg">
              <div class="swiper-slide-caption section-md">
                <div class="container">
                  <h1 data-caption-animate="fadeInLeft" class="banner1" data-caption-delay="0">
                    
                      Encontre seu novo lar hoje mesmo.
                  
                  <p class="text-width-large" data-caption-animate="fadeInRight" data-caption-delay="100"></p><a class="button button-primary button-ujarak" <a href="https://api.whatsapp.com/send?phone=5531985616082&text=Gostaria%20de%20saber%20mais%20sobre%20Imóveis%20disponiveis!!!" target="_blank"  data-caption-animate="fadeInUp" data-caption-delay="200">Saiba mais...</a>
                </div>
              </div>
            </div>
            <div class="swiper-slide" data-slide-bg="images/slider-1-slide-4-1770x742.jpg">
              <div class="swiper-slide-caption section-md">
                <div class="container">
                  <h1 data-caption-animate="fadeInLeft" class="banner3" data-caption-delay="0">Qualidade, confiança e excelência em serviços imobiliários.</h1>
                  <p class="text-width-large" data-caption-animate="fadeInRight" data-caption-delay="100"></p><a class="button button-primary button-ujarak" <a href="https://api.whatsapp.com/send?phone=5531985616082&text=Gostaria%20de%20saber%20mais%20sobre%20Imóveis%20disponiveis!!!" target="_blank"  data-caption-animate="fadeInUp" data-caption-delay="200">Mais informações...</a>
                </div>
              </div>
            </div>
            <div class="swiper-slide" data-slide-bg="images/slider-1-slide-6-1770x742.jpg">
              <div class="swiper-slide-caption section-md">
                <div class="container">
                  <h1 data-caption-animate="fadeInLeft" class="banner3" data-caption-delay="0">Imóveis que combinam qualidade, conforto e estilo</h1>
                  <p class="text-width-large" data-caption-animate="fadeInRight" data-caption-delay="100"></p><a class="button button-primary button-ujarak" <a href="https://api.whatsapp.com/send?phone=5531985616082&text=Gostaria%20de%20saber%20mais%20sobre%20Imóveis%20disponiveis!!!" target="_blank"  data-caption-animate="fadeInUp" data-caption-delay="200">Saiba mais...</a>
                </div>
              </div>
            </div>
      ...
      <section class="section section-sm section-first bg-default text-center" id="services">
        <div class="container">
          <div class="row row-30 justify-content-center">
            <div class="col-md-7 col-lg-5 col-xl-6 text-lg-left wow fadeInUp"><img src="images/juncal.png" alt="" width="415" height="592"/>
            </div>
              ...
              <div class="row row-30">
                <div class="col-sm-6 wow fadeInRight">
                  <article class="box-icon-modern box-icon-modern-custom">
                    <div>
                      <h3 class="box-icon-modern-big-title">Serviços oferecidos</h3>
                    </div>
                  </article>
                </div>
                <div class="col-sm-6 wow fadeInRight" data-wow-delay=".1s">
                  <article class="box-icon-modern box-icon-modern-2">
                    ...
                    <h5 class="box-icon-modern-title"><a href="#">Consultoria<br>Imobiliária</a></h5>
                    <div class="box-icon-modern-decor"></div>
                    <p class="box-icon-modern-text">O corretor de imóveis fornece orientação especializada aos clientes, ajudando-os a entender o mercado imobiliário, as tendências de preços, os melhores bairros e as opções disponíveis.</p>
                  </article>
                </div>
                <div class="col-sm-6 wow fadeInRight" data-wow-delay=".2s">
                  <article class="box-icon-modern box-icon-modern-2">
                    <div class="box-icon-modern-icon linearicons-headset"></div>
                    <h5 class="box-icon-modern-title"><a href="#">Regularização<br>Documental</a></h5>
                    <div class="box-icon-modern-decor"></div>
                    <p class="box-icon-modern-text">O despachante imobiliário cuida dos trâmites burocráticos relacionados à regularização de documentos e certidões necessárias para a compra, venda ou locação de imóveis, como escrituras, registros, certidões negativas, entre outros.</p>
                  </article>
                </div>
                <div class="col-sm-6 wow fadeInRight" data-wow-delay=".3s">
                  <article class="box-icon-modern box-icon-modern-2">
                    <div class="box-icon-modern-icon linearicons-outbox"></div>
                    <h5 class="box-icon-modern-title"><a href="#">Negociação<br>Mediação</a></h5>
                    <div class="box-icon-modern-decor"></div>
                    <p class="box-icon-modern-text"> O corretor atua como intermediário nas negociações entre compradores e vendedores, ou locadores e locatários, buscando alcançar acordos satisfatórios para ambas as partes.</p>
                  </article>
                </div>
              </div>
            </div>
      ...
      <section class="section section-sm section-fluid bg-default text-center" id="projects">
        <div class="container-fluid">
          <h2 class="wow fadeInLeft">Imóveis Disponíveis</h2>
          <div class="isotope-filters isotope-filters-horizontal">
            ...
            <ul class="isotope-filters-list" id="isotope-3">
              ...
              <li><a href="#" data-isotope-filter="Type 1" data-isotope-group="gallery">Para Venda</a></li>
              <li><a href="#" data-isotope-filter="Type 2" data-isotope-group="gallery">Aluguel</a></li>
            </ul>
          </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInRight" data-filter="Type 4">
              ...
              <article class="thumbnail thumbnail-classic thumbnail-md">
                ...
                <div class="thumbnail-classic-caption">
                  <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="images/grid-gallery-1-1200x800-original.jpeg" data-lightgallery="item"><img src="images/fullwidth-gallery-1-420x350.jpg" alt="" width="420" height="350"/></a>
                    <h5>Ampliar</h5>
                  </div>
                  <p class="thumbnail-classic-text">O sítio pequeno com piscina e área de lazer é um refúgio encantador, perfeito para aqueles que buscam momentos de relaxamento e diversão em meio à natureza. Com uma piscina convidativa, você poderá refrescar-se nos dias quentes e desfrutar de momentos de lazer com amigos e familiares.</p>
                </div>
              </article>
            </div>
        ...
        <div class="container">
          <div class="row row-30 row-xl-24 justify-content-center align-items-center align-items-lg-start text-left">
            <div class="col-md-6 col-lg-5 col-xl-4 text-center"><a class="text-img" href="#">
                <div id="particles-js"></div><span class="counter">30+</span></a></div>
            <div class="col-sm-8 col-md-6 col-lg-5 col-xl-4">
              <div class="text-width-extra-small offset-top-lg-24 wow fadeInUp">
                <h3 class="title-decoration-lines-left">Anos de Experiencia</h3>
                <p class="text-gray-500">
                Uma imobiliária com mais de 30 anos de experiência demonstra um conhecimento profundo do mercado imobiliário e das tendências ao longo do tempo. Isso significa que eles têm uma compreensão valiosa das dinâmicas do setor e podem oferecer insights valiosos aos clientes.
                </p>
              </div>
            </div>
              ...
              <div class="row justify-content-center border-2-column offset-top-xl-26">
                ...
                <div class="col-9 col-sm-6">
                  <div class="counter-amy">
                    ...
                    <h6 class="counter-amy-title">Corretores</h6>
                  </div>
                </div>
                <div class="col-9 col-sm-6">
                  <div class="counter-amy">
      ...
      <section class="section section-sm bg-default">
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="left-side">
                  <address class="contact-info text-left"><a href="https://api.whatsapp.com/send?phone=5531985616082&text=Gostaria%20de%20saber%20mais%20sobre%20Imóveis%20disponiveis!!!"><span class="icon mdi mdi-whatsapp novi-icon"></span><span class="text-middle">Whatsapp</span></a></address>
                </div>
                  <p class="box-contacts-link"><a href="https://api.whatsapp.com/send?phone=5531985616082&text=Gostaria%20de%20saber%20mais%20sobre%20Imóveis%20disponiveis!!!">31 98561-6082</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#modalCta" data-toggle="modal">Endereço: Rua Tamoios Nº462 sala 902 - Belo Horizonte - MG</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#modalCta" data-toggle="modal">centroimoveis@gmail.com</a></p>
                  <p class="box-contacts-link"><a href="#modalCta" data-toggle="modal">ricardocirin@gmail.com</a></p>
                </div>
              </article>
            </div>
          </div>
        ...
        <section class="section">    
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3751.1100193332445!2d-43.945588713454825!3d-19.91976809018789!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa699e331e9c7cf%3A0xe84438054a12fd30!2sR.%20dos%20Tam%C3%B3ios%2C%20462%20-%20Centro%2C%20Belo%20Horizonte%20-%20MG%2C%2030120-050!5e0!3m2!1spt-BR!2sbr!4v1689437807720!5m2!1spt-BR!2sbr" width="1750" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>     
        </section>
            ...
            <div class="footer-minimal-bottom-panel text-sm-left">
              <div class="row row-10 align-items-md-center">
                <div class="col-sm-6 col-md-4 order-sm-first">
                  <!-- Rights-->
                  <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span> <span>Centro Imoveis BH</span>
                  </p>
                </div>
                <div class="col-sm-6 col-md-4 text-md-right"><span>Feito&nbsp;por&nbsp;<a href="https://www.jctec.todeboua.com">Feito por JCTEC</a></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4>Converse com o Consultor</h4>
                ...
                <div class="row row-14 gutters-14">
                  <div class="col-12">
                    <div class="form-wrap">
                      ...
                      <label class="form-label" for="contact-modal-name">Nome</label>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-wrap">
